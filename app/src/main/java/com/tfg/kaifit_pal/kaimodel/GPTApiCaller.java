...
public class GPTApiCaller {
    ...
    public void gptApiRequest(String query) {
        if (!isNutritionRelated(query)) {
            kaiQ.addResponseToChat("Lo siento, " +
                    "solo puedo responder preguntas relacionadas con la nutrición deportiva.");
            return;
        }
    ...
    public boolean isNutritionRelated(@NonNull String query) {
        String lowerCaseQuery = query.toLowerCase();
        String[] nutritionKeywords = NutritionKeywords.getKeywords();
